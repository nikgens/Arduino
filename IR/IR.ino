...
if(raw_voltage>3){ //object is less than 8cm form sensor digitalWrite(buzzer,HIGH); delay(1000); digitalWrite(buzzer,LOW); delay(500); }else if(raw_voltage>3 && raw_voltage<4){ //object is less than 7cm from sensor
 digitalWrite(buzzer,HIGH);
 delay(100);
 digitalWrite(buzzer,LOW);
 delay(100);
}else if (raw_voltage<2) //object is less than 4cm from sensor
 digitalWrite(buzzer,HIGH);
}
